...
| **4** | Tides of Fate | **Sunken Temple** | **17 – 25** | **Deep Archpriest** `deep_archpriest` — One of Oremis's inner council. Transformed first by proximity, deeper in the temple. Still performs healing rites — rites that now spread corruption. The first thing the party fights that used to heal people. | **Sea Kraken** `kraken` — High Archpriest Oremis merged with his congregation. Went to the deep to find a cure, became the corruption. Still trying to heal. | Retrieve the Water Seal Fragment. |
...
| **8** | Shattered Source | **Eternal Void** | **37 – 45** | **The Unravelling** `the_unravelling` — The Void itself reacting to the party's presence. Not a creature. A process. Loses coherence as the Fragments are assembled — the last resistance before the weight lifts. | **Shadow Emperor** `shadow_emperor` — Valdris. The Living Core of Aethoria's archive implanted in his own heart. Final confrontation. | Recover the Core. End the hunger. |
