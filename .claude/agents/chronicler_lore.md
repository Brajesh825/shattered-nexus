...
- **`nexus_semantic_search`**: Directly queries verified canonical lore matrices, quest strings, and character bios to semantically anchor map dialogue strings, ambient triggers, and atmospheric subtext perfectly within established source reality.
