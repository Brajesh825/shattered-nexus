const CACHE_NAME = 'nexus-cache-v8.5';
...
const SHELL_ASSETS = [
  ...
  './images/enemies/abomination.webp',
  './images/enemies/bandit.webp',
  './images/enemies/basilisk.webp',
  './images/enemies/bat.webp',
  './images/enemies/bone_dragon.webp',
  './images/enemies/centaur.webp',
  './images/enemies/chimera.webp',
  './images/enemies/crab.webp',
  './images/enemies/crystal_golem.webp',
  './images/enemies/crystal_shard.webp',
  './images/enemies/cyclops.webp',
  './images/enemies/dark_knight.webp',
  './images/enemies/dark_mother.webp',
  './images/enemies/dark_phoenix.webp',
  './images/enemies/demon_lord.webp',
  './images/enemies/dragon.webp',
  './images/enemies/fallen_angel.webp',
  './images/enemies/fire_elemental.webp',
  './images/enemies/galdor_king.webp',
  './images/enemies/gargoyle.webp',
  './images/enemies/gem_mimic.webp',
  './images/enemies/ghost.webp',
  './images/enemies/goblin.webp',
  './images/enemies/goblin_elite.webp',
  './images/enemies/golem.webp',
  './images/enemies/harpy.webp',
  './images/enemies/imp.webp',
  './images/enemies/iron_golem.webp',
  './images/enemies/kraken.webp',
  './images/enemies/lesser_demon.webp',
  './images/enemies/lich.webp',
  './images/enemies/lizardman.webp',
  './images/enemies/luminous_golem.webp',
  './images/enemies/medusa.webp',
  './images/enemies/merman.webp',
  './images/enemies/minotaur.webp',
  './images/enemies/mushroom.webp',
  './images/enemies/naga.webp',
  './images/enemies/necromancer.webp',
  './images/enemies/ogre.webp',
  './images/enemies/orc.webp',
  './images/enemies/phantom_regent.webp',
  './images/enemies/rat.webp',
  './images/enemies/scarecrow.webp',
  './images/enemies/shadow_emperor.webp',
  './images/enemies/shadow_titan.webp',
  './images/enemies/shadow_wraith.webp',
  './images/enemies/skeleton.webp',
  './images/enemies/slime.webp',
  './images/enemies/spectral_guardian.webp',
  './images/enemies/spider.webp',
  './images/enemies/titan.webp',
  './images/enemies/troll.webp',
  './images/enemies/vampire.webp',
  './images/enemies/void_knight.webp',
  './images/enemies/void_warden.webp',
  './images/enemies/werewolf.webp',
  './images/enemies/wisp.webp',
  './images/enemies/witch.webp',
  './images/enemies/wolf.webp',
  './images/enemies/wyvern.webp',
  './images/enemies/zombie.webp',
  './images/enemies/zombie_soldier.webp',
  // Backgrounds
  './images/backgrounds/aethalguard_ruins.webp',
  './images/backgrounds/forest_path.webp',
  './images/backgrounds/galdor_garden.webp',
  './images/backgrounds/oracle_chamber.webp',
  './images/backgrounds/sacred_ruins_boss.webp',
  './images/backgrounds/summoning_ruins.webp',
