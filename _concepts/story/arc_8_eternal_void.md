...
```mermaid
graph TD
    F1[Eternal Void F1<br>The Ash Threshold] -->|Static Collapse| F2[Eternal Void F2<br>Horizon of Unravelling]
    F2 -->|Coherence Threshold| F3[Eternal Void F3<br>The Throne of Stars]
    
    style F1 fill:#09090b,stroke:#52525b,color:#fff
    style F2 fill:#020617,stroke:#3b82f6,color:#fff
    style F3 fill:#000000,stroke:#facc15,color:#fff
```
