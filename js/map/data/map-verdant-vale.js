...
MAP_DEFS.verdant_vale = {
    ...
    encounterTemplates: [
        { weight: 4, enemies: ['goblin', 'goblin', 'goblin'], activePhases: ['dawn', 'noon', 'dusk'] },
        { weight: 3, enemies: ['wolf', 'wolf', 'wolf'], activePhases: ['dusk', 'midnight'] },
        { weight: 2, enemies: ['zombie_soldier', 'zombie_soldier', 'zombie_soldier'], activePhases: ['dusk', 'midnight'] },
        { weight: 3, enemies: ['bat', 'bat', 'bat', 'bat'], activePhases: ['midnight'] },
        { weight: 2, enemies: ['zombie_soldier', 'wolf', 'goblin'], activePhases: ['midnight'] },
        { weight: 3, enemies: ['spider', 'spider', 'spider', 'spider'], activePhases: ['midnight'] },
        { weight: 1, enemies: ['goblin', 'goblin', 'zombie_soldier'], activePhases: ['dusk', 'midnight'] },
